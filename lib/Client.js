var SocketClient = (function () {
	...
	function convertForms() {
		...
		// TODO: this works for hrefs without query strings
		// but we should support query strings someday
		var anchors = document.querySelectorAll("a:not(.fixed)");
		Array.prototype.forEach.call(anchors, function (anchor) {
			var gref = anchor.getAttribute("href").replace(/^.*\//, "");
			anchor.href = "#"+gref;
